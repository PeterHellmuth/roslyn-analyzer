...
namespace DemoAnalyzers.CodeFixes
{
    ...
    public sealed class DateTimeUtcNowCodeFixProvider : CodeFixProvider
    {
        public override ImmutableArray<string> FixableDiagnosticIds => [DateTimeUtcNowAnalyzer.DiagnosticId];
